...
<div class="flex justify-center items-center mt-20">
    <div class="bg-white p-8 rounded-lg shadow-md w-full md:w-500 mx-6">
        ...
        <?php load_partial('errors', ['errors' => $errors ?? []]); ?>
        <form action="/auth/login" method="POST">
            <div class="mb-4">
                <input type="email" name="email" placeholder="Email Address" class="w-full px-4 py-2 border rounded focus:outline-none" value="<?= $email ?? ''; ?>" />
            </div>
            <div class="mb-4">
